...
#   ./scripts/run_pipeline.sh okx_funding_rates
#   ./scripts/run_pipeline.sh okx_funding_rates --backfill
#
# Crontab examples:
#   # Sync instruments daily at 00:00 UTC
#   0 0 * * * /home/ubuntu/clawd/repos/AlphaHub/scripts/run_pipeline.sh okx_instruments
#
#   # Sync funding rates every 8 hours
#   0 */8 * * * /home/ubuntu/clawd/repos/AlphaHub/scripts/run_pipeline.sh okx_funding_rates
#
#   # Full backfill (run once manually)
#   # ./scripts/run_pipeline.sh okx_funding_rates --backfill
